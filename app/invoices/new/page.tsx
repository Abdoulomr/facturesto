    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <button
                          ...
                          className="w-6 h-6 rounded-full bg-stone-100 hover:bg-stone-200 text-stone-700 flex items-center justify-center text-sm font-bold leading-none transition-colors"
                        >
                          −
                        </button>
                      ...
                      <div className="w-20 text-right text-sm font-semibold text-stone-800 shrink-0">
                        {formatFCFA(item.total)}
                      </div>
                      <button
                        onClick={() => removeItem(item.productId)}
                        className="text-stone-300 hover:text-red-400 text-lg leading-none transition-colors ml-1"
                        title="Retirer"
                      >
                        ×
                      </button>
      ...
      <AlertDialog open={emptyCartDialog} onOpenChange={setEmptyCartDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => setEmptyCartDialog(false)}>
              OK
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
